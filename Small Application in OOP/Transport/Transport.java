...
Must call super.display() to display the base class details, and then display the cargo weight limit specific to the truck.
...
Overridden display() Method
Must call super.display() to display base class details, and then display the number of passengers specific to the bus.
...
class Vehicle
{
	...
	public void display()
	{
		...
		System.out.println("The speed of vehicle: "+speed);
		System.out.println("The fuel consumption: "+fuelConsumption);
		System.out.println("The fuel capacity: "+fuelCapacity);
	}
}
class Truck extends Vehicle
{
	...
	{
		super.display();
		System.out.println("The Cargo weight limit is: "+cargoWeightLimit);
	}
}
class Bus extends Vehicle
{
	...
	{
		super.display();
		System.out.println("The number of passengers is: "+numberOfPassengers);
	}
}
